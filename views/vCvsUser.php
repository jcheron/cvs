...
<div>
	<a class="btn btn-default" href="<?php echo Url::get("Users/addCv")?>"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Ajouter un CV</a>
</div>
<ul>
	<?php 
	$index=0;
	foreach ($user->getCvs() as $cv){
		...
		"' class='btn btn-xs btn-lnk'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span>
				</a>";
